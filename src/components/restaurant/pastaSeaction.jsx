...
function pastaSeaction() {
  let [products, setProducts] = useState([]);
  const getProducts = async () => {
      let reponse = await fetch("https://forkify-api.herokuapp.com/api/search?q=pasta")
  ...
  return (
    <Container  > 
      <h1 className='title-section p-5 m-5'>Our Pasta</h1>
